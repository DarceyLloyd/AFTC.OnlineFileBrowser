...
{    
    ...
    public $enable_self_update = false;
    public $animate_bg = false;
    public $image_mode = false;

    public $local_version = "1.9";
...
?>
    ...
    <head>
        ...
        <title>WizardLearning Online File Browser</title>
        <meta description="WizardLearning Online File Browser"/>
    ...
    <div id="layer3">
        <div id="header">
            <h1>Wizardlearning - Private share <span style='font-size:9px;'>v<?php echo($aftc->local_version); ?></span></h1>
            <h2>For support email <a href="mailto:admin@wizardlearning.com" target="_blank">admin@wizardlearning.com</a></h2>
        </div>
        ...
        <div id="footer">
            Support email: <a href="mailto:admin@wizardlearning.com" target="_blank">admin@wizardlearning.com</a>
        </div>
