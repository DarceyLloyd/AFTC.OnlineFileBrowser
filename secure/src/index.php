...
class AFTCDirBrowser
{
    ...
    public function __construct()
    {
        ...
        $this->root = $this->url;
        $this->browser_title = "AFTC Dir & File Browser - Darcey@AllForTheCode.co.uk";
...
?>
    ...
    <div id="layer3">
        <div id="header">
            ...
            <h2>For support email <a href="mailto:Darcey@AllForTheCode.co.uk"
                                     target="_blank">Darcey@AllForTheCode.co.uk</a></h2>
        </div>
        ...
        <div id="footer">
            &copy; Data &amp; Dreams LTD | email: <a href="mailto:darcey@allforthecode.co.uk" target="_blank">Darcey@AllForTheCode.co.uk</a>
        </div>
